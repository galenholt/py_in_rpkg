...
<!-- badges: start -->
[![R-CMD-check](https://github.com/galenholt/py_in_rpkg/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/galenholt/py_in_rpkg/actions/workflows/R-CMD-check.yaml)
<!-- badges: end -->
